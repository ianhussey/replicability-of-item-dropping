...
\urlstyle{same}
\hypersetup{
  pdftitle={Item-dropping based on Cronbach's alpha improves in-sample alpha but not true reliability: A Monte Carlo simulation},
...
\begin{frontmatter}
\title{Item-dropping based on Cronbach's alpha improves in-sample alpha
but not true reliability: A Monte Carlo simulation}
...
itself and describes how much individual studies differ. It stabilizes
with increasing \(K\). At \(K\) = 10,000 the MCSE is roughly one
