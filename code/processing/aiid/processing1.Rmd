...
Output is a wide format data frame saved as a compressed rds object.
...
# get data
load("~/git/AIID-study/data/processed/AIID_data.RData") # take data directly from the AIID repo. https://github.com/ianhussey/AIID-study-public 
#load("~/git/AIID-study/data/subsets/AIID_subset_exploratory.RData")

# trim data 
data_AIID_trimmed <- AIID_data %>%
...
# save to disk
write_rds(data_AIID_trimmed, "../../../data/raw/aiid/data_AIID_trimmed.rds", compress = "gz")
