...
if(file.exists("../../data/processed/data_drop_decisions.rds") & 
   file.exists("../../data/processed/data_drop_decisions_no_data.rds")){
  
  data_drop_decisions <- read_rds("../../data/processed/data_drop_decisions.rds")
  ...
  write_rds(data_drop_decisions, 
            "../../data/processed/data_drop_decisions.rds", 
            compress = "gz")
  ...
  write_rds(data_drop_decisions_no_data, 
            "../../data/processed/data_drop_decisions_no_data.rds", 
            compress = "gz")
