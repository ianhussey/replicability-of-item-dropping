...
- move from replication to novel study. drop the EFA piece.
...
- Choose a strategy that purposefully adds a poorly performing item to the realistic distirbution. Compare via sim the probability of choosing to drop an item when there is vs isnt a bad one, and the probability of choosing the wrong item to drop when there is a bad one.
