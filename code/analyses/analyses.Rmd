...
temp <- data_drop_decisions_no_data %>%
  mutate(alpha_b_diff = alpha_full_scale_b - as.numeric(alpha_if_a_recommendation_dropped_b),
...
temp2 <- temp %>%
  ...
  summarize(proportion_improved = mean(alpha_b_improved, na.rm = TRUE),
  ...
  mutate(proportion_improved = case_when(proportion_improved == 0 ~ 0.001,
...
TODO add frequencies of item drop recommendations
...
## proportion match item if dropped
...
## proportion match item if dropped or nonr
